...
public class MainServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        Controller newProjectController = (Controller) context.getAttribute("newProjectController");
        ...
        controllers.put(Request.create(Method.GET, "/kickstarter/projects"), newProjectController);
        controllers.put(Request.create(Method.POST, "/kickstarter/projects"), addProjectController);
    ...
    private void handleRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            checkAnnotation(request, controller);
    ...
    private void checkAnnotation(Request request, Controller controller) throws InstantiationException, IllegalAccessException {
        controller.getClass();
